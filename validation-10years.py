...
val_list = [
    ("1960-12-31", "1971-12-31", "1969-12-31"),
    ("1961-12-31", "1972-12-31", "1970-12-31"),
    ("1962-12-31", "1973-12-31", "1971-12-31"),
    ("1963-12-31", "1974-12-31", "1972-12-31"),
    ("1964-12-31", "1975-12-31", "1973-12-31"),
    ("1965-12-31", "1976-12-31", "1974-12-31"),
    ("1966-12-31", "1977-12-31", "1975-12-31"),
    ("1967-12-31", "1978-12-31", "1976-12-31"),
    ("1968-12-31", "1979-12-31", "1977-12-31"),
    ("1969-12-31", "1980-12-31", "1978-12-31"),
    ("1970-12-31", "1981-12-31", "1979-12-31"),
    ("1971-12-31", "1982-12-31", "1980-12-31"),
    ("1972-12-31", "1983-12-31", "1981-12-31"),
    ("1973-12-31", "1984-12-31", "1982-12-31"),
    ("1974-12-31", "1985-12-31", "1983-12-31"),
    ("1975-12-31", "1986-12-31", "1984-12-31"),
    ("1976-12-31", "1987-12-31", "1985-12-31"),
    ("1977-12-31", "1988-12-31", "1986-12-31"),
    ("1978-12-31", "1989-12-31", "1987-12-31"),
    ("1979-12-31", "1990-12-31", "1988-12-31"),
    ("1980-12-31", "1991-12-31", "1989-12-31"),
    ("1981-12-31", "1992-12-31", "1990-12-31"),
    ("1982-12-31", "1993-12-31", "1991-12-31"),
    ("1983-12-31", "1994-12-31", "1992-12-31"),
    ("1984-12-31", "1995-12-31", "1993-12-31"),
    ("1985-12-31", "1996-12-31", "1994-12-31"),
    ("1986-12-31", "1997-12-31", "1995-12-31"),
    ("1987-12-31", "1998-12-31", "1996-12-31"),
    ("1988-12-31", "1999-12-31", "1997-12-31"),
    ("1989-12-31", "2000-12-31", "1998-12-31"),
    ("1990-12-31", "2001-12-31", "1999-12-31"),
    ("1991-12-31", "2002-12-31", "2000-12-31"),
    ("1992-12-31", "2003-12-31", "2001-12-31"),
    ("1993-12-31", "2004-12-31", "2002-12-31"),
    ("1994-12-31", "2005-12-31", "2003-12-31"),
    ("1995-12-31", "2006-12-31", "2004-12-31"),
    ("1996-12-31", "2007-12-31", "2005-12-31"),
    ("1997-12-31", "2008-12-31", "2006-12-31"),
    ("1998-12-31", "2009-12-31", "2007-12-31"),
    ("1999-12-31", "2010-12-31", "2008-12-31"),
    ("2000-12-31", "2011-12-31", "2009-12-31"),
    ("2001-12-31", "2012-12-31", "2010-12-31"),
    ("2002-12-31", "2013-12-31", "2011-12-31"),
    ("2003-12-31", "2014-12-31", "2012-12-31")
]
...
def wrapperFunc(path_var, date_start, date_end, var_names, miroc6_filename,N):
    ...
    for n in range(len(lat)):
        ...
        if ~np.isnan(var_ar[0, n]):
            ...
            for month in range(1,13):
                ...
                month_data = merged_df[(merged_df['month'] == month) & ( merged_df['time'] <= val_list[N][2]) & (merged_df['time'] > val_list[N][0])]
                print(month_data)
            ...
            validation_df = merged_df[(merged_df['time'] > val_list[N][2]) & (merged_df['time'] <= val_list[N][1])].copy()
            ...
            file_path = os.path.join("P_bias", f"{lon} , {lat} per month P_bias-RMSE-validation-{str(val_list[N][2])}.csv")
            P_bias_df_original.to_csv(file_path, index=False, float_format='%.2f')
            file_path = os.path.join("PT_results", f"{lon} , {lat} Merged_Transformed_daily-validation-{str(val_list[N][2])}.csv")
            validation_df.to_csv(file_path, index=False, float_format='%.6f')
            print("registred")
for N in range(19,len(val_list)):
    #18 is skipped, runtime error in fitting function
    print(N)
    wrapperFunc(path_var, date_start, date_end, var_names, "prec_MIROC6_historico_-42.1875_-21.711889554404237.csv", N)